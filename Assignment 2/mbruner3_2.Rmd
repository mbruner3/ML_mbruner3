...
# Imported dataset.
```{r}
unibank <- read_csv("UniversalBank.csv", col_types = "iiiiiidiifffff")
head(unibank)
...
The second type of error is a false negative. What this means is that the model predicted a person as not accepting the personal loan but in reality they did accepted it. According to the confusion matrix above, the model said that 138 people would reject the personal loan but in reality (according to the validation set) they accepted it.
