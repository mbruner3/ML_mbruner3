...
Performed the agnes hierarchical clustering and compared it with the diana hierarchical clustering to see if the clusters are similar for both methods which also gives evidence that the clusters are stable. Looking above you can see 52 of the 73 or about 70% cereals were grouped the same as agnes. I believe this gives further evidence of clustering stability as two different clustering algorithms formed mostly the same cluster groupings.  
